...
/// 构建 src/customStruct/instance.zig 模块并完成依赖接线
pub fn build(cfg: Config) *std.Build.Module {
    const m = cfg.b.createModule(.{
        .root_source_file = cfg.b.path("src/customStruct/instance.zig"),
        .target = cfg.target,
    ...
    // 下游: 引擎中需要 @import("instance") 的消费者模块
    cfg.exe.addImport("instance", m);
    cfg.resource.addImport("instance", m);
    cfg.resourceProcess.addImport("instance", m);
    cfg.instances2.addImport("instance", m);
