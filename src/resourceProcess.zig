...
pub const Triggers = [_][:0]const u8{
    createUniqueIndexFileNameAndContentHash,
    createTriggerOnInsertContentPathCheckContentHash,
    createTriggerOnDeleteContentPathUpdateTablesRelativePathWhereSameContentHash,
    createTriggerOnUpdateContentPathUpdateOrInsertTables,
};
