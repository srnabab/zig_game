...
pub fn toVulkan(partialFillInfo: *VulkanPipelineInfo, shaderCodes: [5][]u8, setLayouts: []vk.VkDescriptorSetLayout, vulkan: *global.VkStruct) !void {
    ...
    partialFillInfo.pipelineLayout.layout = try vulkan.createPipelineLayout(partialFillInfo.pipelineLayout.info);
}
